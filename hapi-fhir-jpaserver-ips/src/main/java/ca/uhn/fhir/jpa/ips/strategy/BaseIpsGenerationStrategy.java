...
public abstract class BaseIpsGenerationStrategy implements IIpsGenerationStrategy {
	...
	// private String myDynamicBundleProfile;
	...
	// public void setDynamicBundleProfile(String theProfile) {
	// 	this.myDynamicBundleProfile = theProfile;
	// }
	...
	public String getCompositionProfile() {
		...
		return "http://hl7.org/fhir/uv/ips/StructureDefinition/Composition-uv-ips";
	}
