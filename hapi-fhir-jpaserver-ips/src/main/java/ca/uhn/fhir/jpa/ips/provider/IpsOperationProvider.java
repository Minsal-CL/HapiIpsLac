...
public class IpsOperationProvider {
	...
	public IBaseBundle patientInstanceSummary(
			...
			@Description(
				shortDefinition =
						"Se debe proporcionar una uri de un perfil IPS")
					@OperationParam(name = "profile", min = 1, typeName = "uri") IPrimitiveType<String> theProfile,
			RequestDetails theRequestDetails) {
				
		ValidateUtil.isTrueOrThrowInvalidRequest(theProfile != null, "Profile parameter is required");
		String profile = theProfile.getValueAsString();
