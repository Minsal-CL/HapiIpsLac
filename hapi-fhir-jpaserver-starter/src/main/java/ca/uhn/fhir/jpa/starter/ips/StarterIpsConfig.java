...
public class StarterIpsConfig {
	...
	@Bean
    public IIpsGeneratorSvc ipsGeneratorSvcImpl(FhirContext theFhirContext, DaoRegistry theDaoRegistry) {
        return new IpsGeneratorSvcImpl(theFhirContext, theDaoRegistry);
    }
}
